export namespace appconf {
  export class AppConfig {
    ...
    constructor(source: any = {}) {
      ...
      this.auto_upload_game_save_to_cloud =
        source["auto_upload_game_save_to_cloud"];
      ...
      this.background_hide_game_hero_cover =
        source["background_hide_game_hero_cover"];
...
export namespace vo {
  ...
  export class BatchImportCandidate {
    ...
    constructor(source: any = {}) {
      ...
      this.matched_game = this.convertValues(
        source["matched_game"],
        models.Game,
      );
      this.matched_tags = this.convertValues(
        source["matched_tags"],
        metadata.TagItem,
      );
  ...
  export class GameDetailStats {
    ...
    constructor(source: any = {}) {
      ...
      this.recent_play_history = this.convertValues(
        source["recent_play_history"],
        DailyPlayTime,
      );
    }
  ...
  export class LastPlayedGame {
    ...
    constructor(source: any = {}) {
      if ("string" === typeof source) source = JSON.parse(source);
      this.game = this.convertValues(source["game"], models.Game);
      this.last_played_at = this.convertValues(
  ...
  export class HomePageData {
    ...
    constructor(source: any = {}) {
      if ("string" === typeof source) source = JSON.parse(source);
      this.last_played = this.convertValues(
        source["last_played"],
        LastPlayedGame,
      );
  ...
  export class PeriodStats {
    ...
    constructor(source: any = {}) {
      ...
      this.play_time_leaderboard = this.convertValues(
        source["play_time_leaderboard"],
        GamePlayStats,
      );
      this.timeline = this.convertValues(source["timeline"], TimePoint);
      this.leaderboard_series = this.convertValues(
        source["leaderboard_series"],
        GameTrendSeries,
      );
    }
  ...
  export class StatsExportData {
    ...
    constructor(source: any = {}) {
      ...
      this.leaderboard = this.convertValues(
        source["leaderboard"],
        StatsGameItem,
      );
      this.timeline = this.convertValues(source["timeline"], StatsTimePoint);
      this.leaderboard_trend = this.convertValues(
        source["leaderboard_trend"],
        StatsGameTrend,
      );
