...
function StatsPage() {
  ...
  return (
    <div ref={ref} className="space-y-6 max-w-8xl mx-auto p-8 bg-brand-100 dark:bg-brand-900">
      ...
      <div className="flex justify-between items-center no-export">
        ...
        <button onClick={handleShare} className='flex justify-end i-mdi-share text-2xl text-brand-600 dark:text-brand-400 hover:text-brand-900 dark:hover:text-brand-200 transition-colors'/>
      </div>
      ...
      <div className="mt-8 text-center text-brand-400 dark:text-brand-600 text-sm font-medium">
        Generated by Lunabox
      </div>
    </div>
  )
}
