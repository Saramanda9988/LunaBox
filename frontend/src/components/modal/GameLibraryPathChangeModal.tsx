...
export function GameLibraryPathChangeModal({
  ...
  return (
    <ModalPortal>
      <div
        className="absolute inset-0 z-50 overflow-y-auto bg-black/45 p-4 backdrop-blur-[3px] sm:p-6"
      ...
      >
        <div className="flex min-h-full items-center justify-center">
          <section
            role="dialog"
            aria-modal="true"
            aria-labelledby="game-library-path-change-title"
            className="w-full max-w-3xl overflow-hidden rounded-2xl border border-brand-200 bg-white/98 shadow-2xl shadow-black/20 backdrop-blur-20 dark:border-brand-700 dark:bg-brand-800/98"
          >
            <header className="border-b border-brand-200 px-5 py-5 dark:border-brand-700 sm:px-6">
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <h2
                    id="game-library-path-change-title"
                    className="text-lg font-semibold text-brand-900 dark:text-white"
                  >
