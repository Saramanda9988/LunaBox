    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <BetterSwitch
          ...
          onCheckedChange={checked => onChange({ ...formData, auto_backup_db: checked } as AppConfig)}
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <BetterSwitch
          ...
          onCheckedChange={checked => onChange({ ...formData, auto_backup_game_save: checked } as AppConfig)}
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <BetterSwitch
          ...
          onCheckedChange={checked => onChange({ ...formData, auto_upload_db_to_cloud: checked } as AppConfig)}
      ...
      <div className="flex items-center justify-between">
        ...
        <BetterSwitch
          ...
          onCheckedChange={checked => onChange({ ...formData, auto_upload_game_save_to_cloud: checked } as AppConfig)}
          disabled={!formData.cloud_backup_enabled}
        />
      </div>
      ...
      <div className="pt-4 border-t border-brand-300 dark:border-brand-700 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={e => onChange({ ...formData, local_backup_retention: Number.parseInt(e.target.value) || 0 } as AppConfig)}
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={e => onChange({ ...formData, local_db_backup_retention: Number.parseInt(e.target.value) || 0 } as AppConfig)}
            className="w-full px-3 py-2 border border-brand-300 dark:border-brand-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-neutral-500 dark:bg-brand-700 dark:text-white"
          />
